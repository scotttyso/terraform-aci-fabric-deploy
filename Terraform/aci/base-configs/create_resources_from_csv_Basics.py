...
def resource_callhome(smtp___port, smtp__relay, mangmnt_epg, ch_fr_email, ch_rp_email, ch_to_email, phone_numbr, contact_inf,
    ...
    wr_base_info.write('\tclass_name = "trigSchedP"\n')
    wr_base_info.write('\tpayload    = <<EOF\n')
    wr_base_info.write('{\n')
    ...
    wr_base_info.write('\tclass_name = "callhomeQueryGroup"\n')
    wr_base_info.write('\tpayload    = <<EOF\n')
    wr_base_info.write('{\n')
    ...
    wr_base_info.write('\tclass_name = "callhomeGroup"\n')
    wr_base_info.write('\tpayload    = <<EOF\n')
    wr_base_info.write('{\n')
    ...
    wr_base_info.write('\tclass_name = "callhomeInvP"\n')
    wr_base_info.write('\tpayload    = <<EOF\n')
    wr_base_info.write('{\n')
    ...
    wr_base_info.write('\tclass_name = "callhomeSrc"\n')
    wr_base_info.write('\tpayload    = <<EOF\n')
    wr_base_info.write('{\n')
