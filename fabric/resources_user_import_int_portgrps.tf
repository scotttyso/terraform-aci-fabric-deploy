...
resource "aci_rest" "leaf201_Eth1-01-1_pg" {
	path		= "/api/node/mo/uni/infra/accportprof-leaf201/hports-Eth1-01-1-typ-range/rsaccBaseGrp.json"
	class_name	= "infraRsAccBaseGrp"
	payload		= <<EOF
{
    "infraRsAccBaseGrp": {
...
resource "aci_rest" "leaf201_Eth1-01-2_pg" {
	path		= "/api/node/mo/uni/infra/accportprof-leaf201/hports-Eth1-01-2-typ-range/rsaccBaseGrp.json"
	class_name	= "infraRsAccBaseGrp"
	payload		= <<EOF
{
    "infraRsAccBaseGrp": {
...
resource "aci_rest" "leaf201_Eth1-01-3_pg" {
	path		= "/api/node/mo/uni/infra/accportprof-leaf201/hports-Eth1-01-3-typ-range/rsaccBaseGrp.json"
	class_name	= "infraRsAccBaseGrp"
	payload		= <<EOF
{
    "infraRsAccBaseGrp": {
...
resource "aci_rest" "leaf201_Eth1-01-4_pg" {
	path		= "/api/node/mo/uni/infra/accportprof-leaf201/hports-Eth1-01-4-typ-range/rsaccBaseGrp.json"
	class_name	= "infraRsAccBaseGrp"
	payload		= <<EOF
{
    "infraRsAccBaseGrp": {
...
resource "aci_leaf_access_bundle_policy_group" "r142b-oob_vpc" {
	...
	payload		= <<EOF
{
    "infraRsAccBaseGrp": {
        "attributes": {
            "tDn": "uni/infra/funcprof/accbundle-r142b-oob_vpc"
        },
        "children": []
    }
}
...
resource "aci_leaf_access_bundle_policy_group" "r143-oob_vpc" {
	...
	payload		= <<EOF
{
    "infraRsAccBaseGrp": {
        "attributes": {
            "tDn": "uni/infra/funcprof/accbundle-r143-oob_vpc"
        },
        "children": []
    }
}
...
resource "aci_leaf_access_bundle_policy_group" "r143-dist_vpc" {
	...
	payload		= <<EOF
{
    "infraRsAccBaseGrp": {
        "attributes": {
            "tDn": "uni/infra/funcprof/accbundle-r143-dist_vpc"
        },
        "children": []
    }
}
